  ...
  async function shortenUrl(event) {
    ...
    try {
      const response = await fetch(`${API_BASE}/api/v1/links`, {
        ...
        body: JSON.stringify({ destination_url: destinationUrl, short_code: code }),
      })
        ...
        <section className="hero">
          ...
          <form className="shortener-card" onSubmit={shortenUrl}>
            ...
            <div className="custom-row">
              ...
              <span className="field-help" id="short-code-help">Leave blank to generate one</span>
            </div>
          </form>
          ...
          {result && (
            <section className="result-card" aria-live="polite">
              ...
              <div className="result-actions">
                ...
                <button className="ghost-button" type="button" onClick={loadAnalytics} disabled={analyticsLoading}>
          ...
          {analytics && (
            <div className="analytics-card" id="analytics">
              ...
              <div className="analytics-code">{SHORTENER_ORIGIN}/{analytics.short_code}</div>
            </div>
          )}
        </section>
